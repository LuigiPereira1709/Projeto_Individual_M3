...
class GeradorDadosFicticios:
    def __init__(self):
        ...
        self.tecnologias_data = pd.read_json('tec.json')
        self.cargos_data = pd.read_json('cargos.json')
...
df_empresas.to_csv(f'{prefixo}_empresas.csv', index=False)
df_colaboradores.to_csv(f'{prefixo}_colaboradores.csv', index=False)
df_tecnologias.to_csv(f'{prefixo}_tecnologias.csv', index=False)
